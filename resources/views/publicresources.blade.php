                ...
                <div class="col-md-8">
                    ...
                    <div class="resources-list">
                        ...
                        <div class="resource-item">
                            <div class="resource-title">Microsoft to launch web-based mobile app store in July</div>
                            <a href="{{route('displayresources')}}" class="resource-link">View Resource</a>
                        </div>
                        <div class="resource-item">
                            <div class="resource-title">Angel Montesdeoca, IBM: The role of AI in modern software development</div>
                            <div class="resource-description"> integrating AI into software development tools and accelerating the application lifecycle.</div>
